...
//    model.add(tf.layers.dense({activation: 'relu', units: 1, inputShape: [768, 1024, 1]}))
    model.add(tf.layers.conv2d({filters: 4, kernelSize: 6, strides: 1, activation: 'sigmoid', padding: 'same'}))
    model.add(tf.layers.conv2d({filters: 4, kernelSize: 3, strides: 1, activation: 'sigmoid', padding: 'same'}))
